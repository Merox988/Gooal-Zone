...
const Navbar: React.FC<NavbarProps> = ({ activePage, onNavigate }) => {
  ...
  return (
    <header className="bg-gray-800/70 backdrop-blur-sm shadow-lg sticky top-0 z-50">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex items-center">
            <button onClick={() => onNavigate('home')} className="flex-shrink-0" aria-label="Gooal Zone Home">
              <svg
              ...
              >
                ...
                <g>
                  <path d="M 20 0 C 8 0, 0 8, 0 20 C 0 32, 8 40, 20 40 C 32 40, 40 32, 40 20 C 40 8, 32 0, 20 0 Z" fill="#22C55E" />
                ...
                <text x="50" y="29" fontFamily="system-ui, sans-serif" fontSize="24" fontWeight="900" fontStyle="italic" fill="#FFFFFF" letterSpacing="-1">
          ...
          <nav>
            <div className="flex items-baseline space-x-2 md:space-x-4">
              ...
              <NavLink page="prediction">Prediction</NavLink>
